...
async function addCalendar() {
  try {
    ...
    console.log(`Attempting to add calendar ${calendarId} to service account list...`);
    ...
    console.log('🎉 Successfully added calendar!');
    console.log(`Summary: ${response.data.summary}`);
    console.log(`ID: ${response.data.id}`);
    console.log(`Access Role: ${response.data.accessRole}`);

  } catch (error) {
    console.error('❌ Failed to add calendar:', error.message || error);
