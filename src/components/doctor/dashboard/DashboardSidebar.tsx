...
const navigation = [
  ...
  { name: "Reportes", href: "/doctor/reportes", icon: "chart" as const },
  { name: "Finanzas", href: "/doctor/finanzas", icon: "money" as const },
  { name: "Configuración", href: "/doctor/configuracion", icon: "settings" as const },
];
      ...
      {navigation.map((item) => {
        ...
        return (
          <Link
            ...
            href={item.href}
            onClick={onNavigate}
            className={`group flex items-center gap-3 rounded-2xl px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.14em] transition ${
              active
